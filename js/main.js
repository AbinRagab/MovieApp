...
//         return "Name Must Be between 6 and 14 characters And Frist char Upper";
//     }
//     else if (regiMail.test(mailInputV.value)== false){
//         return "NOt Valid Mail Must Be as (Examble@domain.com)";
//     }
//     else if (regixPhone.test(phoneInputV.value)== false){
//         return "NOt Vaild Phone Number Must Be As (01234567891,201234567890,+201234567890 )"
//     }
//     else if (regixAge.test(ageInputV.value)== false){
//         return "Age Must be more than 18 and less than 60";
//     }
//     else if (regixPasswd.test(passInputV.value)== false){
//         return "Password Must more than 8 char and atleast one uppercase, lowercase";
//     }
